...
class divorce(Dataset):
    ...
    def __init__(self, data_path = './Data/divorce.h5', train = True, scaler = None):
        import h5py
...
def load_data(path_data = './', batch_size = 32, scaler = None):

    train_set = divorce(data_path = path_data, train = True, scaler = scaler)
    train_loader = torch.utils.data.DataLoader(
        train_set, batch_size=len(train_set), shuffle=True, num_workers=0)

    test_set = divorce(data_path = path_data, train = False, scaler = scaler)
...
if __name__ == '__main__':
    ...
    train_set, train_loader, test_set, test_loader = load_data(path_data, batch_size = batch_size, scaler = scaler)
    ...
    # torch.save(model.state_dict(), os.path.join(path_model, 'divorce_model.pt'))
